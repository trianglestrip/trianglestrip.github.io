import{S as e}from"./index-Bmx42yJ1.js";import"./oitFragment-Ekb0G1ln.js";import"./harmonicsFunctions-C6VGNkuT.js";import"./mainUVVaryingDeclaration-JvWuUeXZ.js";import"./imageProcessingFunctions-DOIxDeus.js";import"./logDepthDeclaration-2EomghL8.js";import"./fogFragment-CxaFHScq.js";import"./helperFunctions-YZlCMFm8.js";import"./logDepthFragment-Hhtzi4h6.js";import"./meshUboDeclaration-Cmma5dBI.js";const n="pbrFragmentDeclaration",H=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
varying vec4 vColor;
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=x);const o="samplerFragmentAlternateDeclaration",W=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=W);const r="pbrFragmentSamplersDeclaration",X=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=X);const t="subSurfaceScatteringFunctions",k=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=k);const f="importanceSampling",Y=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDggx(vec2 u,float a) {float phi=2.*PI*u.x;float cosTheta2=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDCharlie(vec2 u,float a) { 
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=Y);const c="pbrHelperFunctions",w=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=z);const d="pbrDirectLightingFalloffFunctions",q=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=q);const s="pbrBRDFFunctions",K=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=K);const E="hdrFilteringFunctions",$=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=$);const R="pbrDirectLightingFunctions",Z=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=Z);const C="pbrIBLFunctions",J=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=J);const u="pbrBlockAlbedoOpacity",j=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=j);const m="pbrBlockReflectivity",Q=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=Q);const S="pbrBlockAmbientOcclusion",ee=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=ee);const A="pbrBlockAlphaFresnel",ie=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=ie);const v="pbrBlockAnisotropic",ne=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=ne);const I="pbrBlockReflection",ae=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=ae);const N="pbrBlockSheen",oe=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=oe);const T="pbrBlockClearcoat",re=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=re);const O="pbrBlockIridescence",te=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=te);const p="pbrBlockSubSurface",fe=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=fe);const L="pbrBlockNormalGeometric",ce=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=ce);const g="pbrBlockNormalFinal",le=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=le);const h="pbrBlockLightmapInit",de=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=de);const M="pbrBlockGeometryInfo",se=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=se);const _="pbrBlockReflectance0",Ee=`float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);vec3 specularEnvironmentR0=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=Ee);const D="pbrBlockReflectance",Re=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=Re);const F="pbrBlockDirectLighting",Ce=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=Ce);const P="pbrBlockFinalLitComponents",ue=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
#endif
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=ue);const b="pbrBlockFinalUnlitComponents",me=`vec3 finalDiffuse=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=me);const U="pbrBlockFinalColorComposition",Se=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=Se);const B="pbrBlockImageProcessing",Ae=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=Ae);const G="pbrBlockPrePass",ve=`float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
#endif
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=ve);const y="pbrDebug",Ie=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=Ie);const i="pbrPixelShader",V=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=V);const Fe={name:i,shader:V};export{Fe as pbrPixelShader};
