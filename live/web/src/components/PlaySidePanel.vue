  ...
  >
    ...
    <div v-show="tab === 'follow'" class="tab-content scrolly follow-tab">
      <PlayFollowRecommendTabs
        ...
        @play-room="$emit('play-room', $event)"
      />
    </div>

    <div v-show="tab === 'recommend'" class="tab-content scrolly recommend-tab">
      <PlayFollowRecommendTabs
        active-panel="recommend"
        :follow-poll-active="false"
        :site="site"
        :room-id="roomId"
        :room-category="roomCategory"
        :room-cid="roomCid"
...
const { sortedFollows, refresh: refreshFollowStatus } = useFollowStatus(
